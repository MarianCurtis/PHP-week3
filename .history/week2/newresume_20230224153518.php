          ...
          <div class="col-6">
            <form action="replace.php" method="Post">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email"  placeholder="name@example.com" name>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Can we contact you back?</label>
                <div class="form-check">
                  <input type="radio" class="form-check-input" value="Yes" checked>
              ...
              <button class="btn btn-danger my-2" type="button" role="button">Submit</button>
            </form>
          </div>
        </div>
      </div>
