  ...
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (empty($_POST["name"])) {
        ...
        //check if email address if formatted correctly
            ...
            <!--Name Field-->
              ...
              <div class="form-group">
                ...
                <div class="form-check">
                  <input type="radio" class="form-check-inpu<?php if ((isset ($contBack)) && ($contBack == "Yes")) {echo "checked";} ?>t" name="contact-back" id="yes" value="Yes" <?php if ((isset ($contBack)) && ($contBack == "Yes")) {echo "checked";} ?> />
