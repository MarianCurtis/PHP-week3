...
?>
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">Managed multi-departmental teams to analyze manufacturing processes using the DMAIC Method to help minimize waste I worked on several projects and ate tacos too. One of my favorite things to do as a
