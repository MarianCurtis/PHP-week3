...
?>
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">I have received my Web Development from Salt Lake Community College.  Course includes: HTML, CSS, JAVASCRIPT, PHP, WordPress.  I did a 6 week internship for GOPAC Inc. (Give Old People a Chance).  As part of a team of 6 interns, we created and set up their first web site
