...
?>
    ...
    <section id="about">
        ...
        <div class="row align-items-center justify-content-center text-center py-5">
            ...
            <img src="http://localhost:3000/week4/PortfolioPic">
        </div>
        <div class="col-md-8 my-3">
            <h2 class="font-weight-bold">Marian Curtis</h2>
            <hr class="my-4">
            <p class="font-weight-light mx-5">Sometimes, you just gotta eat some tacos and be gorgeous like me!</p>
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">I have managed several multi-departmental teams to analyze manufacturing processes using the DMAIC Method to help minimize waste, reduce inventory and increase productivity.</p>
    <!-- Card Footer Starts -->
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">I am ISO 9001 Lead Auditor Certified. I have audited over 50 companies for compliance to FDA requirements.  Companies include: Dietary Supplement Manufacturers and Customer facing suppliers, Food and Cosmetic companies, and Raw Material Suppliers. One of my favorite parts of auditing is identifying areas of improvement. I also managed our company Internal Auditing </p>
    <!-- Card Footer Starts -->
        <footer class="card-footer">
                <a href="#about" class="btn btn-outline-danger btn-lg mt-2">Learn more</a>
        </footer>
