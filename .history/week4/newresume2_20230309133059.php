...
?>
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">I have received my Web Development from Salt Lake Community College.  Course includes: HTML, CSS, JAVASCRIPT, PHP, WordPress.  I did a 6 week internship for GOPAC Inc. (Give Old People worked on several projects while eating tacos. One of my favorite things to do as a
