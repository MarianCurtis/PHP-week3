...
<body>
    ...
    <!-- Card Body Starts -->
        <div class="card-body">
            ...
            <hr class="bg-primary">
            <p class="card-text">I am am ISO 9001 Certified Lead Auditor. I have audited over 50 companies for compliance to FDA regulations.  Companies include: Dietary Supplement Manufacturers and Customer facing suppliers, Food and Cosmetic companies, and Raw Material Suppliers. One of my favorite parts of auditing is identifying areas of improvement. I also managed our company Internal Auditing Department that comprised of .</p>
    <!-- Card Footer Starts -->
        <footer class="card-footer">
                <a href="#about" class="btn btn-outline-danger btn-lg mt-2">Learn more</a>
        </footer>
