  ...
  if (!lisset($_SESSION)) {
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST") && (!($formErr))) { 
      ...
      try {
          ...
          //C$_SESSION['message'] = '<p class="font-weight-bold">Thank you for your submission!</p><p class="font-weight-light">Your request has been sent.</p>';reate error message
