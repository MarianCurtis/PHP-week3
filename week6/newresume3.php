...
<body>
    ...
    function newList($array) {
        ...
        ?>
                ...
                <div class="text-center">
                    <h3>My Skills and Interests Include:</h3>
    ...
    <!-- Card Image -->
            <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2968&q=80"
            alt="pm_1" class="card-img-top" style="object-fit: cover; height:15em;">
    <!-- Card Body Starts -->
        <div class="card-body">
            <h3 class="card-title">Process Improvement</h3>
            <hr class="bg-primary">
            <p class="card-text">I managed several multi-departmental teams to analyze manufacturing processes using the DMAIC Method to help minimize waste, reduce inventory and increase productivity. I also lead teams using the TQM (Total Quality Management) method to improve customer satisfaction by getting the entire organization involved with continuous process improvement.</p>
    <!-- Card Footer Starts -->
    ...
    <!-- Card Start -->
        <div class="card bg-light text-center border-light shadow h-100">
            <!-- Card Image -->
            <img src="https://plus.unsplash.com/premium_photo-1663075884608-3956200d5260?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2583&q=80"
            alt="pm_1" class="card-img-top" style="object-fit: cover; height:15em;">
    <!-- Card Body Starts -->
        <div class="card-body">
            <h3 class="card-title">ISO Certified Auditor</h3>
            <hr class="bg-primary">
            <p class="card-text">I am am ISO 9001 Certified Lead Auditor. I have audited over 50 companies for compliance to FDA regulations.  Companies include: Dietary Supplement Manufacturers and Customer facing suppliers, Food and Cosmetic companies, and Raw Material Suppliers. One of my favorite parts of auditing is identifying areas of improvement. I ocersaw and managed our company Internal Audit Department that comprised of multi-departmental personal reporting to me.</p>
    <!-- Card Footer Starts -->
        <footer class="card-footer">
                <a href="#about" class="btn btn-outline-danger btn-lg mt-2">Learn more</a>
        </footer>
